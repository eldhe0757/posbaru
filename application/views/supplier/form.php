                        ...
                        <form action="<?=site_url('supplier/proses') ?>" method="post">
                            <div class="row col-md-12">
                                <div style="<?=$disp1?>" class="form-group col-md-6 ">
                                    ...
                                    <input type="text" value="<?=$kdsup ?>" name="kd_supplier" id="" class="form-control" readonly> 
                                </div>
                                <div style="<?=$disp2?>" class="form-group col-md-6 ">
                                    <label for=""> Kode Supplier</label>
                                    <input type="text" value="<?=$row->kd_supplier ?>" name="kd_supp" id="" class="form-control" readonly> 
                                </div>
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input type="text" value="<?=$row->nm_bank ?>" name="nm_bank" id="" class="form-control" required> 
                                </div>
                                <div class="form-group col-md-6 ">
                                    <label for=""> No. Rekening *</label>
                                    <input type="number" value="<?=$row->no_rek ?>" name="no_rek" id="" class="form-control" required> 
                                </div>
                            </div>
                            <div class="row col-md-12">
                                <div class="form-group col-md-6 ">
