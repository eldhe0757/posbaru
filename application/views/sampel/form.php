    ...
    <div class="content">
        <div class="card card-<?=$warna?> card-outline">
            <div class="card-header">
                <h3 class="card-title"><?=$page?> Data sampel</h3>
                <div class="float-right">
                    <a href="<?=site_url('sampel')?>" class="btn btn-warning">
            ...
            <div class="card-body"> 
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="<?=site_url('sampel/proses') ?>" method="post">
                                <div class="form-group">
                                    <input type="hidden" name="id" value="<?=$row->id_sampel ?>">
                                    <label for=""> Nama sampel *</label>
                                    <input type="text" value="<?=$row->nama ?>" name="nama" class="form-control" required> 
                                </div>
