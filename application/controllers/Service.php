...
class Service extends CI_Controller {
    ...
    public function add()
    {
        ...
        $service->dp = null;
        $cust = $this->customer_m->get()->result();
        $data = array(
            'warna' => 'success',
            'blok' => '',
            'kcs' => $this->customer_m->kcs(),
            'cust' => $cust,
            'page' => 'Tambah',
    ...
    {
        $data = $this->service_m->simpancust();
    ...
    public function terima_print($id)
	{
		$data = array (
			'row' => $this->service_m->custedit($id)->row(),
		);
		$this->load->view('service/terima_print', $data);
